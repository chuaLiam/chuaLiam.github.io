<template>
  <v-card>
    <v-img :src="require('@/assets/GT/GT_ENTRANCE_1.png')">
      ...
      <v-layout xs4>
        <v-flex class="text-xs-left">
          <Arrows_left :link="'/GT_BEntranceFar'" />
        </v-flex>
      </v-layout>
      <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /> <br /> <br /> <br />
      ...
      <v-layout>
        <v-flex class="text-xs-center">
          <Arrows_back :link="'/GT_EntranceShuttle'" />
        </v-flex>
      </v-layout>
    </v-img>
  </v-card>
...
export default {
  components: { MapNavbar, Arrows_back, Arrows_forward, Arrows_left },
  data () {
    return {
    }
  }
