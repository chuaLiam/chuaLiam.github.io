<template>
  <v-card>
    <v-img :src="require('@/assets/GT/CLASSROOM.png')">
      <MapNavbar :guide="['-Most of the classes are held in the classrooms at the 2nd Floor of the GT Building.']"
