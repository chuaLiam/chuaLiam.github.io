<template>
  <v-card>
    <v-img :src="require('@/assets/GT/Dorm_Room.png')">
      ...
      <v-layout>
        <v-flex class="text-xs-center">
          <Arrows_forward :link="'/Arthaland_studyHall'" />
        </v-flex>
      </v-layout>
      <br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /> <br /> <br /> <br />
      <v-layout xs4>
        <v-flex class="text-xs-left">
          <Arrows_left :link="'/Arthaland_Entrance'" />
        </v-flex>
      </v-layout>
    </v-img>
  </v-card>
...
export default {
  components: { MapNavbar, Arrows_forward, Arrows_left },
  data () {
    return {
    }
  }
